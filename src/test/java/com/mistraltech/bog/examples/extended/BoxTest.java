...
import com.mistraltech.bog.examples.extended.builder.AbstractBoxBuilder.BoxBuilder;
...
public class BoxTest {
    ...
    public void testBoxOfInteger() {
        Box<Integer> integerBox = BoxBuilder.<Integer>aBox().withContents(25).build();
        assertThat(integerBox.getContents(), is(equalTo(25)));
    }

    @Test
    public void testBoxOfPerson() {
        Box<Person> personBox = BoxBuilder.<Person>aBox().withContents(aPerson().withName("Bob")).build();
